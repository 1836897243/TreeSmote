...
# Properties
_method_name = "SmoteEasyEnsembleClassifier"
...
class SmoteEasyEnsembleClassifier(ResampleBaggingClassifier):
    ...
    def __init__(
        ...
        *,
        ...
        sampler = _sampler_class(k_neighbors=self._k_neighbors, replacement=True, random_state=random_state)
        sampling_type = _sampling_type
        ...
        if estimator is None:
            ...
            warn(
                ...
                f" base estimator. A typical SmoteEasyEnsembleClassifier uses"
...
if __name__ == "__main__":  # pragma: no cover
    ...
    easyens = SmoteEasyEnsembleClassifier(**init_kwargs).fit(**fit_kwargs)
    ...
    easyens_fallback = SmoteEasyEnsembleClassifier(**init_kwargs).fit(**fit_kwargs)
