"""SmoteBalancedRandomForestClassifier: Forest classifiers trained 
...
# Properties
_method_name = "SmoteBalancedRandomForestClassifier"
...
class SmoteBalancedRandomForestClassifier(
    ...
    def _validate_estimator(self, default=DecisionTreeClassifier()):
        ...
        self.sampler_ = RandomUnderOverSampler(
...
if __name__ == "__main__":  # pragma: no cover
    ...
    brf = SmoteBalancedRandomForestClassifier(**init_kwargs).fit(**fit_kwargs)
    ensembles["brf"] = brf
