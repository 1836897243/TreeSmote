"""SmoteUnderBaggingClassifier: A Bagging classifier with intergrated 
...
# Properties
_method_name = 'SmoteUnderBaggingClassifier'
...
class SmoteUnderBaggingClassifier(ResampleBaggingClassifier):
    ...
    at fit time using a RandomUnderOverSampler.
    ...
    estimator : object, default=None
        ...
        ``Pipeline([RandomUnderOverSampler(), DecisionTreeClassifier()])``.
    ...
    def __init__(
        ...
        *,
        ...
        sampler = _sampler_class(k_neighbors=k_neighbors, replacement=True, random_state=random_state)
        sampling_type = _sampling_type
...
if __name__ == "__main__":  # pragma: no cover
    ...
    underbagging = SmoteUnderBaggingClassifier(**init_kwargs).fit(**fit_kwargs)
