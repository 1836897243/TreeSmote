...
RandomUnderSampler # doctest: +NORMALIZE_WHITESPACE
    ...
    def __init__(
        self, *, sampling_strategy="auto", random_state=None, replacement=False, over_sampling_config: dict = None,
    ):
        super().__init__(sampling_strategy=sampling_strategy, over_sampling_config=over_sampling_config)
